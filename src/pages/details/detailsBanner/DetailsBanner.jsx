...
const DetailsBanner = ({ video, crew }) => {
    ...
    //make array of ids of geners and send it to genres component
    const genres_ids = data?.genres?.map((genre) => genre.id);
                                ...
                                <div className="info">
                                    ...
                                    {data?.release_date && (
                                        <div className="infoItem">
                                            ...
                                            <span className="text">
                                                {dayjs(data?.release_date || "00-00-0000").format("MMM D, YYYY")}
                                            </span>
                                        </div>
                                    )}
                                    {data?.runtime && (
